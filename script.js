(function($, undefined) {
  ...
  function showRepo(repo) {
    ...
    // For watchers add ( + repo.watchers + ' watchers &middot; ' ) 

    $link.append('<p class="repo__info">' + getRepoLang(repo) + '</p>');
  ...
  $.getJSON('https://api.github.com/users/' + userName + '/repos?per_page=100&callback=?', function(result) {
